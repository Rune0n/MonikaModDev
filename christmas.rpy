...
label monika_relax
    m 3j "Isn't winter a beautiful time of year, my love?"
    m 3a "The glistening, white snow, the bright and colorful lights~"
    m 4b "I love it."
    m 1o "..."
    m 1e "Except for the blizzards~"
    m "And the icy roads~"
    m 1p "And the dangerous, bitter cold."
    m 1l "But I guess you can't have beauty without a little speck of evil hidden deep within."
    m 2a "If it gets bad here, just stay home and stay safe, okay [player]?"
    m 1d "After all, when the weather gets bad~"
    m 1a "Isn't it best to relax at home?"
    m 1k "Wearing pajamas, drinking hot chocolate, reading a good book, and of course~"
    m 5a "Talking to me!"
    m 1j "Ehehe~"
    m 1i "But seriously, don't go outside if it gets too bad."
