...
label monika_depress
    m 1o "You know something that really gets to me?"
    m 1g "Christmas is supposed to be about sharing and caring~"
    m "Being with your family and friends~"
    m 2f "The happiest time of the year."
    m 1p "But not everyone can do that."
    m 1g "Some people are forced to work in order to make ends meet~"
    m 1r "And for others it can be even worse."
    m 2g "Christmas could end up being a painful reminder of a divorce."
    ...
    m 3j "And you have me, your dashing girlfriend, along with all of your friends and family."
    m 3a "So let's look at today as the gift it really is to us."
    m 4k "A reminder of what we have."
