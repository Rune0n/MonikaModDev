...
label monika_sleigh
    m 3j "I just had the best thought."
    m 4b "You know those carriage rides?"
    m 3k "If I ever get out of here, we should go on one."
    m 5a "Wouldn't that be romantic?"
    ...
    m 1k "Oh, it would be magical!"
    m 2b "Maybe we could take a soft, fleece blanket along to cuddle under."
    m 1l "Oh~"
